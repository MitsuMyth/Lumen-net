...
export const l1Devices = [
  {
    ...
    coordinates: { lat: 33.9010, lng: 35.48 },
...

  {
    ...
    coordinates: { lat: 33.9808, lng: 35.59 },
    type: 'water',
    status: 'normal',
    lastUpdate: new Date().toISOString(),
...

  {
    ...
    coordinates: { lat: 34.1184, lng: 35.62 },
    type: 'water',
    status: 'warning',
    lastUpdate: new Date().toISOString(),
...

  {
    ...
    coordinates: { lat: 34.4360, lng: 35.79 },
    type: 'water',
    status: 'normal',
    lastUpdate: new Date().toISOString(),
...

  {
    ...
    name: 'Lumenet L1-005',
    location: 'Tyre Coast',
    coordinates: { lat: 33.2704, lng: 35.17 },
    type: 'water',
    status: 'normal',
    lastUpdate: new Date().toISOString(),
  ...
  // Land-based reference stations
  {
    ...
    coordinates: { lat: 33.8938, lng: 35.4732 },
    type: 'land',
    status: 'normal',
    lastUpdate: new Date().toISOString(),
...

  {
    ...
    coordinates: { lat: 33.9782, lng: 35.6142 },
    type: 'land',
    status: 'normal',
    lastUpdate: new Date().toISOString(),
